...
<@layout title="${settings.links_title!} | ${options.blog_title!}" keywords="${options.seo_keywords!}" description="${options.seo_description!}">
                ...
                <header class="cover page-header">
                    ...
                    <div class="cover-content">
                        <div class="inner">
                            ...
                            <h1 class="page-title" style="font-size: 46px;">${settings.links_title!}</h1>
                        </div>
                    </div>
                </header>
                <div class="links-box">
